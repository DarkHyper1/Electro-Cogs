...
class UGReport:
    ...
    async def ugreport(self, ctx, person, *, reason): #changed terminology. Discord has people not players.
        ...
        embed.set_footer(text="Created with love by DJ Electro") #Lovely thing for a footer
